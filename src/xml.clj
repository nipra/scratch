...
(def *url "http://index05:8983/solr/core0/admin/stats.jsp")

(def *xml (slurp *url))

(def *input-source (InputSource. (clojure.java.io/reader "http://index05:8983/solr/core0/admin/stats.jsp")))
...
(comment
  (let [input-source (InputSource. (clojure.java.io/reader "http://index05:8983/solr/core0/admin/stats.jsp"))
